...
# //=================FUNCIONES DEL GLICH=================//
async def mostrar_mensaje_malo():
...
# =========================================================================
# LÓGICA PRINCIPAL (Ahora envuelta en la función async obligatoria)
# =========================================================================

async def main():
    global jugando, primera_partida, jefe, jefes_derrotados, enemigos_abatidos_ocultos
    global tiempo_inicio_nivel, duracion_nivel, vida, puntos, enemigos_abatidos
    global enemigos, balas, balas_enemigas, mundo, fondo_color, explosiones
    global modificadores_activos, contador_escudo, contador_disparo_triple, musica_muted
    ...
    while True:
        ...
        while juego_en_progreso and vida > 0:
                            ...
                            for ev in pygame.event.get():
                                ...
                                if ev.type == pygame.KEYDOWN:
                                    ...
                                    if ev.key == pygame.K_ESCAPE:
                                        pygame.quit()
                                        exit()
                            await asyncio.sleep(0)  # <-- OBLIGATORIO EN LA PAUSA
            ...
            await asyncio.sleep(0)  # <-- OBLIGATORIO PARA EL JUEGO PRINCIPAL EN LA WEB
